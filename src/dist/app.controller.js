...
var AppController = /** @class */ (function () {
    ...
    __decorate([
        common_1.Post('login'),
        swagger_1.ApiOperation({ summary: 'Login to service' }),
        swagger_1.ApiResponse({ status: 200, description: 'Logged in' }),
        swagger_1.ApiResponse({ status: 401, description: 'Username or password failed' }),
